...
public interface TicketRepository extends JpaRepository<Ticket, Long> {
    ...
    //Kiểm tra vé có tồn tại theo seat + trip chống đặt trùng
    boolean existsBySeatIdAndStatusNot(Long seatId, TicketStatus status);

    // VNPay/PayOS: tìm vé theo mã vé
    Optional<Ticket> findByTicketCode(String ticketCode);

    //Báo cáo thống kê doanh thu theo tháng trong năm
    ...
    //Top 5 chuyến xe có lượt đặt vé cao nhất
